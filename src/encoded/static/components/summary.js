...
class SummaryBody extends React.Component {
    ...
    render() {
        ...
        const vertFacetNames = ['assay', 'protocol.title', 'biosample_classification', 'biosample_ontologies.system_slims', 'biosample_ontologies.organ_slims', 'biosample_ontologies.term_name', 'award.focus', 'award.project', 'award.coordinating_pi.title', 'lab.title'];
        const vertFacets = []
