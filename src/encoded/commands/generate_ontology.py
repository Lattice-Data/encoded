...
def main():
    ...
    uberon_url = 'https://github.com/obophenotype/uberon/releases/download/v2023-09-05/uberon.owl'
    mondo_url = 'https://github.com/monarch-initiative/mondo/releases/download/v2023-08-02/mondo.owl'
    hancestro_url = 'https://raw.githubusercontent.com/EBISPOT/hancestro/3.0/hancestro-base.owl'
    cl_url = 'https://github.com/obophenotype/cell-ontology/releases/download/v2023-08-24/cl.owl'
